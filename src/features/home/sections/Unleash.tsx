...
const Unleash = () => {
  ...
  return (
    <div className="lg:grid grid-cols-2 mx-auto place-items-center container gap-14 lg:px-0 px-5">
      <Heading
      ...
      <div className="space-y-6 max-w-[630px] mx-auto">
        ...
        />
        <p className="font-medium text-gray-600 font-prompt leading-[25px]">
        ...
        <div className="flex flex-wrap gap-10 font-prompt justify-center">
          {data?.map((item: any, idx: number) => (
            <UnleashCard data={item} key={idx} className="font-bold" />
          ))}
        </div>
      </div>
    </div>
